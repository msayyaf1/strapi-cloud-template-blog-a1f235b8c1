...
export interface ApiContactContentContactContent
  ...
  attributes: {
    ...
    contactFormText: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatToExpect: Schema.Attribute.JSON;
  };
}

export interface ApiFilmingBookingFormFilmingBookingForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'filming_booking_forms';
  info: {
    description: 'Filming location booking form submissions';
    displayName: 'Filming Booking Form';
    pluralName: 'filming-booking-forms';
    singularName: 'filming-booking-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::filming-booking-form.filming-booking-form'
    > &
      Schema.Attribute.Private;
    locations: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMediaContentMediaContent extends Struct.SingleTypeSchema {
  collectionName: 'media_contents';
  info: {
    description: 'Manage photo galleries and news articles for the media page';
  ...
  attributes: {
    ...
    galleryCategories: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    newsArticles: Schema.Attribute.JSON;
    pageDescription: Schema.Attribute.Text;
    pageTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Media Gallery'>;
    photoGallery: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPageContentPageContent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Manage static page content like hero sections, about text, etc.';
  ...
  attributes: {
    ...
    welcomeImage: Schema.Attribute.Media<'images'>;
    welcomeMessage: Schema.Attribute.RichText;
  };
}

export interface ApiShopRentalFormShopRentalForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'shop_rental_forms';
  info: {
    description: 'Shop rental application form submissions';
    displayName: 'Shop Rental Form';
    pluralName: 'shop-rental-forms';
    singularName: 'shop-rental-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shop-rental-form.shop-rental-form'
    > &
      Schema.Attribute.Private;
    phoneNumber: Schema.Attribute.String & Schema.Attribute.Required;
    preferredSpace: Schema.Attribute.Enumeration<
      [
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Heritage village team members';
...
export interface ApiTourBookingFormTourBookingForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'tour_booking_forms';
  info: {
    description: 'Guided tour booking form submissions';
    displayName: 'Tour Booking Form';
    pluralName: 'tour-booking-forms';
    singularName: 'tour-booking-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-booking-form.tour-booking-form'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
...
export interface ApiVenueBookingFormVenueBookingForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'venue_booking_forms';
  info: {
    description: 'Event venue booking form submissions';
    displayName: 'Venue Booking Form';
    pluralName: 'venue-booking-forms';
    singularName: 'venue-booking-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    firstName: Schema.Attribute.String & Schema.Attribute.Required;
    guestCount: Schema.Attribute.String & Schema.Attribute.Required;
    lastName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::venue-booking-form.venue-booking-form'
    > &
      Schema.Attribute.Private;
    phoneNumber: Schema.Attribute.String & Schema.Attribute.Required;
    preferredVenue: Schema.Attribute.Enumeration<
      [
        'Al Jazeera Al Hamra Fort',
        'Baraha',
        'Houses',
        'Majlis',
        'Abdul Kareem House',
    ...
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    submittedAt: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2025-08-13T20:45:00.000Z'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::shop-rental-form.shop-rental-form': ApiShopRentalFormShopRentalForm;
      'api::team-member.team-member': ApiTeamMemberTeamMember;
      'api::tour-booking-form.tour-booking-form': ApiTourBookingFormTourBookingForm;
      'api::venue-booking-form.venue-booking-form': ApiVenueBookingFormVenueBookingForm;
